...
import { FoodPreferenceListRelationFilter } from "../../foodPreference/base/FoodPreferenceListRelationFilter";
...
class MemberWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => FoodPreferenceListRelationFilter,
  })
  @ValidateNested()
  @Type(() => FoodPreferenceListRelationFilter)
  @IsOptional()
  @Field(() => FoodPreferenceListRelationFilter, {
    nullable: true,
  })
